...
![Grid for export](../../tutorials/figures/cgmes_grid.png){#fig-cgmesgrid}
...
![Exported ZIP file with all CGMES profiles](../../tutorials/figures/cgmes_zip_all_exported.png){#fig-cgmesZipAll}
...
![Selected profiles, unzipped](../../tutorials/figures/cgmes_nozip.png){#fig-cgmesNoZip}
...
![Structure of imported grid](../../tutorials/figures/cgmes_structure_after_import.png){#fig-structureAfterImport}

But the resulting grid model still looks the same as the original:

![Imported grid](../../tutorials/figures/cgmes_reimported.png){#fig-cgmesReimportedGrid}
...
![Original reactive power setpoints of loads](../../tutorials/figures_cgmes_qset.png){#fig-qSetOrig}
...
![new reactive power in reference model](../../tutorials/figures/cgmes_new_q.png){#fig-cgmesNewQ}

While in the new model it is still like it was before:

![Reactive power in imported model](../../tutorials/figures/cgmes_original_q.png){#fig-cgmesOriginalQ}
...
![Changes to reference model were transferred to new model](../../tutorials/figures/cgmes_new_q.png){#fig-cgmesNewQ2}
