...
The method `monitor_signals_of_slots` adds result variables for all input and output signals. The method `monitor_signals_of_dsl_models` adds also internal variables and states of DSL models.
