...
try:
    ...
    %timeit act_prj_cached.get_attr(terminal_cached, "uknom")
...
```{python}
terminal_cached = act_prj_cached.get_unique_obj(r"Network Model\Network Data\Grid\Bus 01")
...
%timeit act_prj_cached.set_attr(terminal_cached, {"vmax": 1.06, "vmin": 0.01})
