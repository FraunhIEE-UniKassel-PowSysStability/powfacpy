...
`get_upstream_obj` returns an upstream object that meets a condition (i.e. the method goes upwards in the folder hierarchy until a parent object is found that meets the condition).
