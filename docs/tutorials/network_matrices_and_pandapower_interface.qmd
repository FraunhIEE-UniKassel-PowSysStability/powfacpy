...
::: {.callout-note}
`pandapower` is an optional dependency of *powfacpy*. Install it with `pip install powfacpy[pandapower]` (or `pip install pandapower`) before running this tutorial.
:::
