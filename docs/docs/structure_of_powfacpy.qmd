...
- [*base/active_project.py*](../../src/powfacpy/base/active_project.py)
...
- [*pf_classes/*](../../src/powfacpy/pf_classes)
...
Note that there is a *protocols.py* file in the root directory for compatibility with versions prior to 0.3.0. It is no longer maintained and *pf_classes/protocols.py* should be used.
:::

## Applications
- [*applications/*](../../src/powfacpy/applications/)
...
## Result Variables
- [*result_variables.py*](../../src/powfacpy/result_variables.py)
...
## Deprecated 
- [*deprecated/*](../../src/powfacpy/deprecated/) (not shown in @fig-file-tree)
...
### *base/base.py*
- [*base/base.py*](../../src/powfacpy/base/base.py)
...
### *base/functional.py*
- [*base/functional.py*](../../src/powfacpy/base/functional.py)
...
- [*engineering_helpers.py*](../../src/powfacpy/engineering_helpers.py) 

These are generic helper functions in the electrical and power engineering domain.

## *exceptions.py*
- [*exceptions.py*](../../src/powfacpy/exceptions.py) 
