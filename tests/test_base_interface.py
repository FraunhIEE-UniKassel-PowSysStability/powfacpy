...
def test_replace_outside_of_strings_in_a_string(pfbi, activate_test_project):
    conditions = "lorem ipsum control 1 == 'ABC control 1' 'control 1' control 1"
    conditions = powfacpy.PFStringManipulation.replace_outside_of_strings_in_a_string(
