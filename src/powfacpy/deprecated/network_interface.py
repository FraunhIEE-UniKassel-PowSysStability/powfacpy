...
class PFNetworkInterface(powfacpy.PFActiveProject):
    ...
    def copy_grid(self, grid_or_path, target_folder, new_name,
        ...
        """
        grid_to_be_copied = self._handle_single_pf_object_or_path_input(
            grid_or_path)
        ...
        new_network_diagram = self.copy_single_obj(
            ...
            new_name=new_name, overwrite=True)
        ...
        for graphical_net_obj in graphical_net_objects:
            ...
            path_in_grid = self.get_path_between_objects(
                grid_to_be_copied, element)
            graphical_net_obj.pDataObj = self.get_single_obj(
    ...
    def get_parent_grid(self, obj_or_path):
        ...
        return self.get_upstream_obj(
            obj_or_path,
            lambda x: x.GetClassName == "IntNet")
